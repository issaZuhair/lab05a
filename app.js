...
function sumArray(sumArr) { //eslint-disable-line
  ...
  sum(summation,testArray[2]);
  answerArray.push(summation);
  answerArray.push(testArray+' was passed in as an array of numbers, and ' + summation+' is their sum.');
  return answerArray;
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  multiply(multiple,testArray[2]);
  multiplicationarray.push(multiple);
  multiplicationarray.push('The numbers '+testArray +' have a product of '+ multiple+'.');
